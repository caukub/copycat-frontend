...
<nav class="mb-9 items-center bg-hostify-blue py-2.5 text-xs sm:text-base">
				...
				<div class="flex md:ml-6 md:items-center md:space-x-4">
					...
					>
						<svg
							...
							viewBox="0 0 24 24"
							fill="currentColor"
							class="mr:2 h-5 w-5 sm:mr-2 sm:mr-2.5 sm:h-6 sm:w-6"
						>
							<path
								fill-rule="evenodd"
					...
					>
						<svg
							...
							fill="currentColor"
							viewBox="0 0 16 16"
							class="mr-2.5 h-5 w-5 sm:h-6 sm:w-6"
						>
							<path
					...
					>
						<svg
							class="-ml-0.5 h-5 w-5 sm:ml-0.5"
							viewBox="0 0 20 20"
							fill="currentColor"
							aria-hidden="true"
						>
